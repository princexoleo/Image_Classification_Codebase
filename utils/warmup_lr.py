...
def adjust_learning_rate_step(optimizer, learning_rate, gamma, epoch,step_index, iteration, epoch_size):
    ...
    lr = learning_rate * (gamma ** (step_index))
    for param_group in optimizer.param_groups:
        param_group['lr'] = lr
    return lr

# Define a function that will adjust the learning cosine rate
